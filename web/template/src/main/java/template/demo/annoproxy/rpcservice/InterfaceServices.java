package template.demo.annoproxy.rpcservice;

import sviolet.slate.common.x.proxy.interfaceinst.InterfaceInstance;
import template.demo.annoproxy.fakerpc.FakeRpc;
