package template.demo.properties.config;
 ...
 */
@Configuration
//启用ConfigurationProperties(允许配置绑定到Bean上), 见template.demo.properties.prop包中的配置类
@EnableConfigurationProperties
@ComponentScan({
        "template.demo.properties.controller",
        "template.demo.properties.prop"
})
