package template.demo.annoproxy.controller;
...
import template.demo.annoproxy.customservice.CustomService;
import template.demo.annoproxy.rpcservice.ClassServices;
import template.demo.annoproxy.rpcservice.InterfaceServices;
...
public class AnnotationProxyController {
    ...
    public String service3(){
        ...
        return customService.method("i am input");
    }
