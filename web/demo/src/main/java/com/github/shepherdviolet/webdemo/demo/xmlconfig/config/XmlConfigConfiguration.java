package com.github.shepherdviolet.webdemo.demo.xmlconfig.config;
...
import com.github.shepherdviolet.webdemo.demo.xmlconfig.entity.XmlBean;
...
@Configuration
@ComponentScan({
        "com.github.shepherdviolet.webdemo.demo.xmlconfig.controller",
})
