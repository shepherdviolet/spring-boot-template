...
// <replace-by> import ${java_package}.infra.error.HttpStatusException;
import __java_package__.infra.error.HttpStatusException;
// <replace-by> import ${java_package}.infra.error.RejectException;
import __java_package__.infra.error.RejectException;
...
public class CoreRestController {
    ...
    /**
     * GET请求示例
     * http://localhost:8080/get?param=hello
     */
    @RequestMapping("/get")
